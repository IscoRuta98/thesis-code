...
# directory path
dirPath = r'/home/isco/Documents/SamplePapers/'
ListOfPapers = os.listdir(dirPath)
...
# Read in the PDF
for paper in range(len(ListOfPapers)):

    pdf_document = dirPath + ListOfPapers[paper]
    print("Checking Article: ", ListOfPapers[paper])
